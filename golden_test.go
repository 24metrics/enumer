...
func TestGolden(t *testing.T) {
	for _, test := range golden {
		runGoldenTest(t, test, false, false, false, false, false, false, false, "", "")
	}
...
func runGoldenTest(t *testing.T, test Golden,
	generateJSON, generateYAML, generateSQL, generateText, generateBSON, linecomment, generateGQLGen bool,
	...
	g.generate(tokens[1], generateJSON, generateYAML, generateSQL, generateText, generateBSON, generateGQLGen, "noop", trimPrefix, prefix, linecomment)
	got := string(g.format())
